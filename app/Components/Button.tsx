...
const variantStyles = {
  solid: {
    ...
    amber:
      "bg-amber-100 text-amber-900 hover:bg-amber-200 active:bg-amber-200 active:text-amber-900 focus-visible:outline-amber-100",
  },
  outline: {
    slate:
      "ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-slate-200 focus-visible:ring-slate-300",
    white:
